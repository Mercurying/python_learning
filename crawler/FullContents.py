...
class Douban(object):
    def __init__(self,*args,**kwargs):
        self.conn = pymysql.connect(host='192.168.220.132', port=3306, user='root', password='admin123', db='douban', charset='utf8')
        self.cursor = self.conn.cursor()
        self.sql_info = "INSERT IGNORE INTO `douban_mov` (`title`, `score`,`num`,`link`,`time`,`actors`)  VALUES(%s,%s,%s,%s,%s,%s)"
