...
例如：client =pymongo.MongoClient('mongodb://localhost:27017/')可以达到同样的连接效果。
"""
# 指定数据库
...
# 新增 insert insert_one  insert_many
...
# 可以使用类似find({'_id': {'$gt': ObjectId('593278c815c2602678bb2b8d')}})
# 这样的方法来查询，记录好上次查询的_id。


# 更新 update update_one update_many
